...
In addition to this, I have built scalable applications using React.js, Node.js, Express.js, Next.js, React Native, FastAPI, and Flask, with MongoDB, MySQL, and PostgreSQL. My focus areas include UI/UX design, RESTful APIs, third-party API integrations, authentication and authorization mechanisms, state management tools (Redux Toolkit and Redux Saga), CI/CD pipelines, Lambda and serverless functions, debouncing techniques, webhooks, MongoDB pipelines and aggregations, and cloud platforms such as Hostinger VPS, GCP, AWS, and Azure.
